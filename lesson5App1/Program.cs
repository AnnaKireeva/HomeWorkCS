...
namespace lesson5App1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            const string destDirectName = @"C:\Users\1\Desktop\HomeWorkCS\lesson5App1\pap";
            const string InfoFileName = @"C:\Users\1\Desktop\HomeWorkCS\lesson5App1\Info.csv";
            const string SavePathName = @"C:\Users\1\Desktop\HomeWorkCS\lesson5App1\Lesson12Homework.txt";
